...
SoSeparator* Painter::getShapeSep(Mesh* mesh, const vector<int>& filled)
{
	...
	{
		mat->diffuseColor.set1Value(filled[i], 1, 0, 0); //vert color according to its x-y-z coord (for mesh1) and to the transferred color (for mesh2)
	}
